...
router.patch('/users/:userId/membership/cancel', validateObjectId('userId'), cancelUserMembership)
router.get('/requests', getVendorRequests)
router.patch('/requests/:id/status', validateObjectId('id'), updateVendorRequestStatus)
